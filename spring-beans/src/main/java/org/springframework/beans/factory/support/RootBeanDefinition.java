 ...
 *
 * 翻译：根bean定义表示合并的bean定义，该定义在运行时支持Spring BeanFactory中的特定bean。
 ...
 *
 * 翻译：<p>根Bean定义也可以用于在配置阶段注册单个Bean定义。但是，从Spring 2.5开始，
 * 以编程方式注册Bean定义的首选方法是{@link GenericBeanDefinition}类。
