 ...
 *
 * 翻译：GenericBeanDefinition是一站式商店，用于标准bean定义。
 ...
 *
 * 翻译：<p>通常，使用此{@code GenericBeanDefinition}类来注册用户可见的bean定义
 * （后处理器可能对其进行操作，甚至可能重新配置父名称）。在碰巧是父子关系的地方，
 * 使用{@code RootBeanDefinition} / {@code ChildBeanDefinition}。
 *
