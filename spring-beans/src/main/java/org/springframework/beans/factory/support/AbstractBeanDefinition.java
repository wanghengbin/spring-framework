 ...
 *
 * 翻译：具体的，成熟的{@link BeanDefinition}类的基类，排除了{@link GenericBeanDefinition}，
 ...
 * interface.
 *
 * 翻译：<p>自动装配常数与{@link org.springframework.beans.factory.config.AutowireCapableBeanFactory}
 * 接口中定义的常数匹配。
 *
 * @author Rod Johnson
